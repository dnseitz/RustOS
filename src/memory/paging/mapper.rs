...
impl Mapper {
    ...
    /// The 'PRESENT' flag is added by default. Needs a 'FrameAllocator'
    /// as it might need to create new page tables.
    ...
    /// The free frame is alloated from the given 'FrameAllocator'.
    ...
    /// Identity map the given frame with the provied flags.
